...
- (void)viewDidLoad {
    ...
    //    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithTarget:self andAction:@selector(setting) andImage:@"navigationbar_arrow_down" andHighImage:@"navigationbar_arrow_up"];
